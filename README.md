...
- Download the [baseline notebook](https://github.com/wandb/qualcomm-contest) to get started. PLEASE NOTE: This notebook contains code for loading the gym environment, preprocessing data, and calcuating & logging the cumulate average reward metrics. 
